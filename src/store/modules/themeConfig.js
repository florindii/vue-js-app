...
const actions = {
  ...
  changeVerticalSidebarMini({ commit}, data) {
    commit("toggleVerticalSidebarMini", data);
  },
...
const mutations = {
  ...
  toggleVerticalSidebarMini(state, data) {
    if(data === true){
      state.themeMode.verticalSidebarMini = data;
    }
    else{
