  ...
  <div>
    ...
    <div class="delete-popup" v-show="showDeletePopup" ref="deletePopup">
      <div class="popup-holder">
        ...
        <p class="title">Pflegeplan loschen</p>
        ...
        <div class="description-holder">
          ...
          <p class="description">
            Möchten Sie diese Pflegeplan wirklich löschen? Diese Aktion kann
    ...
    >
      {{
        hasError
          ? "There was an error"
          : `Successfully ${isDeleteAlert ? "deleted" : "edited"}  task`
      }}
    </v-alert>
...
export default {
  ...
  methods: {
    ...
    async deleteTask() {
      ...
      try {
        ...
        if (response.status === 200) {
          // console.log("taskDeleted: ", response);
    ...
    populateFields() {
      // console.log("fields to populate: ", this.taskData);
    ...
    async editTask() {
      ...
      // console.log("repeat: ", this.repeatlValue);
      ...
      // console.log("updateAll: ", this.updateAll);
      // console.log("treeId: ", this.finalBaumSelectionId);
      ...
      try {
        ...
        if (response.status === 200) {
          // console.log("EditedTaskResponse: ", response);
