      ...
      <v-card-text>
        <v-form @submit.prevent="submitForm">
          <v-row>
            ...
            <v-col cols="6">
            <v-text-field class="textFieldTwo" style="margin-top: 50px;" label="Deutsch" outlined v-model="parasit.germanName" :rules="rules.germanName" ></v-text-field>            </v-col>
          </v-row>
          <v-row>
            <v-col cols="5">
...
import DeleteParasit from './DeleteParasit.vue'
...
export default {
  ...
  if (this.parasit.id) {
    axios
      .put("https://tilia.rrota.org/api/ParasitType/Update", requestBody, {
        headers: {
