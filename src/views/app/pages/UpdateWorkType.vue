 ...
 <v-dialog v-model="visible" max-height="500" max-width="700">
    <v-card>
      ...
      <v-toolbar dense color="gray" dark>
        <v-toolbar-title class="title" style="float:center;">Bearbeiten Massnahme</v-toolbar-title>
...
import DeleteWorkType from './DeleteWorkType.vue'
...
export default {
  ...
  if (this.workType.id) {
    axios
      .put("https://tilia.rrota.org/api/WorkType/Update", requestBody, {
        headers: {
      ...
      if (response.status === 200) {
              ...
              this.alertText = "Das Massnahme wurde erfolgreich aktualisiert";
              setTimeout(() => {
