 ...
 <v-dialog v-model="visible" max-height="500" max-width="700">
    <v-card>
      ...
      <v-toolbar dense color="gray" dark>
        <v-toolbar-title class="title" style="float:center;">Bearbeiten Verkehrssicherheit</v-toolbar-title>
...
import DeleteRoadSafety from './DeleteRoadSafety.vue';
...
export default {
  ...
  if (this.roadSafety.id) {
    axios
      .put("https://tilia.rrota.org/api/RoadSafety/Update", requestBody, {
        headers: {
      ...
      if (response.status === 200) {
              ...
              this.alertText = "Das Verkehrssicherheit wurde erfolgreich aktualisiert";
              setTimeout(() => {
